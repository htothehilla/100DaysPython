#lambda allows you to create throwaway functions that can be used to shorten lines of code
...
poem = str(input("how many words are in the poem ?"))
letters = lambda x: len(poem)
print("The poem has {} words".format(letters(poem)))

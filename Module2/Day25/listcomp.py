...
# By iterating through the list using string manipulations and a for loop,
# a list can be generated using conditions that would take 3+ lines of code normally.
...
#List comprehensions can be used against tuples in a list as well. By calling the position in the tuple,
# filters and transformations can be completed on any element within the tuple.
